// =====================================================================
// localStorage 기반 시뮬레이션 스토리지
// =====================================================================
//
// 본 모듈은 백엔드 없는 MVP에서 "의뢰 → 제안 → 연락 허용" / "연락 요청 → 수락"
// 의 전체 흐름이 사용자 화면상 자연스럽게 이어지도록 하기 위한 클라이언트 측
// 영속화 레이어이다.
//
// COMPLIANCE NOTE:
//   - 본 스토리지는 어디까지나 사용자 본인의 브라우저에서만 동작한다.
//     운영자(Assign)가 어떤 의뢰를 어떤 전문가에게 전달했는지 기록하거나
//     매칭하지 않는다.
//   - "보낸 제안" / "받은 제안"은 시뮬레이션 데이터이며, 실제 운영자가
//     특정 전문가를 추천한 결과가 아니다.
...
// ---------------------------------------------------------------------
// 내 제안 (Expert 측 — 시뮬레이션상 본인이 전문가로서 의뢰에 보낸 제안)
// ---------------------------------------------------------------------
